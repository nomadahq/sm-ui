...
export var IconContract = function(p) { return <svg {...S} {...p}><path d="M8 21h-2a3 3 0 0 1 -3 -3v-1h5.5"/><path d="M17 8.5v-3.5a2 2 0 1 1 2 2h-2"/><path d="M19 3h-11a3 3 0 0 0 -3 3v11"/><path d="M9 7h4"/><path d="M9 11h4"/><path d="M18.42 12.61a2.1 2.1 0 0 1 2.97 2.97l-6.39 6.42h-3v-3l6.42 -6.39"/></svg> }
...
// ═══ ADMIN SIDEBAR ICONS ═══
export var IconAddressBook = function(p) { return <svg {...S} {...p}><path d="M20 6v12a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2"/><path d="M10 16h6"/><circle cx="13" cy="11" r="2"/><path d="M4 8h3"/><path d="M4 12h3"/><path d="M4 16h3"/></svg> }
export var IconChartHistogram = function(p) { return <svg {...S} {...p}><path d="M3 3v18h18"/><path d="M20 18v3"/><path d="M16 16v5"/><path d="M12 13v8"/><path d="M8 16v5"/><path d="M3 11c6 0 5-5 9-5s3 5 9 5"/></svg> }
export var IconReportMoney = function(p) { return <svg {...S} {...p}><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><path d="M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2"/><path d="M14 11h-2.5a1.5 1.5 0 0 0 0 3h1a1.5 1.5 0 0 1 0 3H10"/><path d="M12 17v1m0-8v1"/></svg> }
export var IconMoneybag = function(p) { return <svg {...S} {...p}><path d="M9.5 3h5a1.5 1.5 0 0 1 1.5 1.5 3.5 3.5 0 0 1-3.5 3.5h-1A3.5 3.5 0 0 1 8 4.5 1.5 1.5 0 0 1 9.5 3"/><path d="M4 17v-1a8 8 0 1 1 16 0v1a4 4 0 0 1-4 4H8a4 4 0 0 1-4-4"/></svg> }
export var IconActivityHeartbeat = function(p) { return <svg {...S} {...p}><path d="M3 12h4.5l1.5-6 4 12 2-9 1.5 3H21"/></svg> }
export var IconMessageCircle = function(p) { return <svg {...S} {...p}><path d="M3 20l1.3-3.9c-2.324-3.437-1.426-7.872 2.1-10.374 3.526-2.501 8.59-2.296 11.845.48 3.255 2.777 3.695 7.266 1.029 10.501-2.666 3.235-7.615 4.215-11.574 2.293L3 20"/></svg> }
export var IconGlobe = function(p) { return <svg {...S} {...p}><circle cx="12" cy="12" r="9"/><path d="M3.6 9h16.8"/><path d="M3.6 15h16.8"/><path d="M11.5 3a17 17 0 0 0 0 18"/><path d="M12.5 3a17 17 0 0 1 0 18"/></svg> }
export var IconDevWindow = function(p) { return <svg {...S} {...p}><rect x="2" y="3" width="20" height="18" rx="3"/><circle cx="6" cy="6.5" r="0.8" fill="currentColor" stroke="none"/><circle cx="9" cy="6.5" r="0.8" fill="currentColor" stroke="none"/><circle cx="12" cy="6.5" r="0.8" fill="currentColor" stroke="none"/><line x1="2" y1="9" x2="22" y2="9"/><polyline points="7 13.5 10 16.5 7 19.5"/><line x1="13" y1="19.5" x2="18" y2="19.5"/></svg> }
...
export var IconHeadset = function(p) { return <svg {...S} {...p}><path d="M4 14v-3a8 8 0 1 1 16 0v3"/><path d="M18 19c0 1.657 -2.686 3 -6 3"/><path d="M4 14a2 2 0 0 1 2 -2h1a2 2 0 0 1 2 2v3a2 2 0 0 1 -2 2h-1a2 2 0 0 1 -2 -2v-3z"/><path d="M15 14a2 2 0 0 1 2 -2h1a2 2 0 0 1 2 2v3a2 2 0 0 1 -2 2h-1a2 2 0 0 1 -2 -2v-3z"/></svg> }
